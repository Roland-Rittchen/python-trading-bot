...
class Event(object):
    ...
    """
    #def created(self):
    #    self.created = datetime.time

    def done(self): # pylint: disable=E0202
        self.done = datetime.datetime.now(datetime.timezone.utc)    
...
class BarEvent(Event):
    ...
    def __init__(self, bardata, pair):
        """
        Initialises the MarketEvent.
        """
        self.data = bardata
